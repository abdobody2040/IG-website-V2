...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("zl2tfo7g")

  // remove
  collection.schema.removeField("tijedv98")

  // remove
  collection.schema.removeField("i8lm7mfp")

  // remove
  collection.schema.removeField("6hnxtwut")

  // remove
  collection.schema.removeField("njwgpdqs")

  // remove
  collection.schema.removeField("yilngqh2")

  // remove
  collection.schema.removeField("mwor8iws")

  // remove
  collection.schema.removeField("me2e23pk")

  // remove
  collection.schema.removeField("wlkzj8qv")

  // remove
  collection.schema.removeField("iwwp1zmv")

  // remove
  collection.schema.removeField("e25gcv5u")

  // remove
  collection.schema.removeField("w7mmxuat")

  // remove
  collection.schema.removeField("of7ss5yz")

  // remove
  collection.schema.removeField("n3mtjctu")

  // remove
  collection.schema.removeField("wvf8vnlw")

  // remove
  collection.schema.removeField("bmtoppob")

  // remove
  collection.schema.removeField("6uognvnd")
