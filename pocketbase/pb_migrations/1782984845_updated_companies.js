...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("zlqncrgh")

  // remove
  collection.schema.removeField("ou7tcd6b")

  // remove
  collection.schema.removeField("osegmi5h")

  // remove
  collection.schema.removeField("dkeovmen")

  // remove
  collection.schema.removeField("kuitw9cy")

  // remove
  collection.schema.removeField("q74zzhzv")

  // remove
  collection.schema.removeField("cdmpog3b")

  // remove
  collection.schema.removeField("0bor6skb")

  // remove
  collection.schema.removeField("k4zgdna0")

  // remove
  collection.schema.removeField("mpmb16pu")

  // remove
  collection.schema.removeField("juppimcr")

  // remove
  collection.schema.removeField("dr4sh40b")

  // remove
  collection.schema.removeField("hvz5dnjk")

  // remove
  collection.schema.removeField("xwefjomr")

  // remove
  collection.schema.removeField("efcqdul3")
