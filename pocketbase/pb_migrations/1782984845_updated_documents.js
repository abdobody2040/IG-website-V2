...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("n7tnrulm")

  // remove
  collection.schema.removeField("3thsfzhy")

  // remove
  collection.schema.removeField("xzu8zb4t")

  // remove
  collection.schema.removeField("gys0y7nx")

  // remove
  collection.schema.removeField("maeffwzm")

  // remove
  collection.schema.removeField("nyuhfzsh")

  // remove
  collection.schema.removeField("csmfxsny")

  // remove
  collection.schema.removeField("4j85h5rw")

  // remove
  collection.schema.removeField("rz9hanyz")

  // remove
  collection.schema.removeField("i0uekufm")
