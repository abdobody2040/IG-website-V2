...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("rsvo5osw")

  // remove
  collection.schema.removeField("inhue0zu")

  // remove
  collection.schema.removeField("9d7sfjbb")

  // remove
  collection.schema.removeField("apwj9hgg")

  // remove
  collection.schema.removeField("msraniis")

  // remove
  collection.schema.removeField("bjppbrda")

  // remove
  collection.schema.removeField("6dvadd4n")
